...
class Welcome(commands.Cog):
    ...
    async def on_member_join(self, member):
        ...
        welcome_channel_id = 1461276851304398880   # Your welcome channel
        ...
        embed = discord.Embed(
            ...
            description=(
                "Use the buttons below to check out our server rules and all the essentials you need to get started."
            ),
            color=0x71368A
        )
...
async def setup(bot):
    ...
    print("Welcome system loaded successfully")